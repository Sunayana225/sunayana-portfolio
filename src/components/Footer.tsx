...
const Footer = () => {
  const currentYear = 2023; // Static year to avoid hydration mismatch

  return (
    <footer className="bg-background text-muted-gray py-8 px-6 md:px-12 text-center w-full">
      <div className="container mx-auto flex flex-col items-center justify-center gap-4">
        ...
        <p className="text-base text-muted-gray">
          &copy; {currentYear} Sunayana Yakkala. All rights reserved.
        </p>
      </div>
    </footer>
  );
